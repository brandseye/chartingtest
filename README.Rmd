...
You can install the this library using the `devtools` package. You can copy and paste
the code below in to the RStudio console:
...
The next step is to authenticate yourself. This lets the library know who
